## AMR — Autistic Movie Ranker `(v2 — Bugonia)`
...
The only exception is ***Pacing***, which is rated on a scale of 1 to 3:
 ...
 1. Rushed or dragged [🥁](https://boxd.it/7bQA)
 2. OK
...
$`\Huge R =  \left\lfloor 99 \cdot \frac{C - m}{M - m} + 1 \right\rceil`$
